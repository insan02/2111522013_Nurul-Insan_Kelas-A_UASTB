...
public class proses extends crud {
    ...
    public void insert() throws SQLException {
        ...
        try {
            ListPaket();
            // Input Kode Pembeli
            System.out.println("Masukkan Kode Pembeli : ");
            KodePembeli = input.next();
            ...
            String sql = "INSERT INTO transaksi (IDTransaksi, NamaPembeli, KodePembeli, NamaPaket, JenisPaket, Tagihan, Bayar, Kembalian) VALUES ('"
                    + IDTransaksi + "','" + NamaPembeli + "','" + KodePembeli + "','" + NamaPaket + "','" + JenisPaket
                    + "','" + Tagihan + "','" + Bayar + "','" + Kembalian + "')";
            // connect ke database
    ...
    public void display() throws SQLException {
        ...
        try {
            ...
            while (result.next()) {
                ...
                System.out.print("\nNama Pembeli\t: ");
                System.out.print(result.getString("KodePembeli"));
                System.out.print("\nNama Paket\t: ");
